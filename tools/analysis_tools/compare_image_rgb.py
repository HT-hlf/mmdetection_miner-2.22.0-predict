...
def creat_dir(out_dir):
    if not os.path.isdir(out_dir):
        os.makedirs(out_dir)
sum_path_list=[r'G:\mmdetection_miner_result\work_dirs_rgb_simple',r'G:\mmdetection_miner_result\work_dirs_depth_simple','G:\mmdetection_miner_result\work_dirs_rgb_depth_attention_cbam_d_b_simple']
...
save_path=r'G:\mmdetection_miner_result/compare_image_rgb'
creat_dir(save_path)
