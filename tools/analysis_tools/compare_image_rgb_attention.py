...
def creat_dir(out_dir):
    if not os.path.isdir(out_dir):
        os.makedirs(out_dir)
sum_path_list=[r'G:\mmdetection_miner_result\work_dirs_rgb_depth_diy_d_simple',r'G:\mmdetection_miner_result\work_dir_rgb_depth_attention_se_d_simple',r'G:\mmdetection_miner_result\work_dirs_rgb_depth_attention_cbam_d_simple',r'G:\mmdetection_miner_result\work_dirs_rgb_depth_attention_cbam_d_b_simple']
...
save_path=r'G:\mmdetection_miner_result/compare_image_attention'
creat_dir(save_path)
rgb_path = os.path.join(sum_path_list[0], 'val', 'image1','rgb')
rgb_path_list=os.listdir(rgb_path)
depth_path = os.path.join(sum_path_list[0], 'val', 'image1','depth')
for rgbpath in rgb_path_list:
    ...
    for sum_path in sum_path_list[1:]:
        sum_path_ele_rgb = os.path.join(sum_path, 'val', 'image1', 'rgb')
        ...
        sum_path_ele_depth = os.path.join(sum_path, 'val', 'image1', 'depth')
