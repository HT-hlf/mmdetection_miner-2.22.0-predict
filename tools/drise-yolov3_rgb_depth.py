...
def main(args):
    ...
    depth_image = depth_path + args.image_path
    rgb_image = rgb_path + args.image_path
    ...
    save_path_depth = os.path.join(args.save_dir,
                             args.image_path.split('/')[-1].split(".")[0] + "-bbox-id-" + str(args.bbox_index) +'_depth' +".jpg")
...
def parse_args():
    ...
    parser.add_argument('--save-dir',
                        type=str,
                        default = 'DRISE/YOLOV3_rgb_depth_d_b',
                        help='save dir.')
