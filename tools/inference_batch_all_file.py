...
if __name__ == '__main__':
    ...
    config_file = 'configs/yolo/yolov3_d53_mstrain-416_273e_coco_rgb_depth_diy_b.py'
    checkpoint_file = '../../mmdetection_miner_result\work_dirs_rgb_simple\epoch_207.pth'
    ...
    for filename in os.listdir(path):
        ...
        result = inference_detector(model, img, img_prefix_miner='../data/ht_cumt_rgbd/val2014/',
