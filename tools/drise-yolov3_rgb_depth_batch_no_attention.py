...
def parse_args():
    ...
    parser.add_argument('--config',
                        type=str,
                        default = 'configs/yolo/yolov3_d53_mstrain-416_273e_coco_rgb_depth_diy_d.py',
                        help='Yolo V3 configuration.')
    parser.add_argument('--checkpoint',
                        type=str,
                        default = r'G:\mmdetection_miner_result\work_dirs_rgb_depth_diy_d_simple/epoch_135.pth',
                        help='checkpoint.')
    ...
    parser.add_argument('--save-dir',
                        type=str,
                        default = r'G:\mmdetection_miner_result\work_dirs_rgb_depth_diy_d_simple\val\drise',
                        help='save dir.')
