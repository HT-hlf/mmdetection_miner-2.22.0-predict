...
def parse_args():
    ...
    parser.add_argument('--config',
                        type=str,
                        default = 'configs/yolo/yolov3_d53_mstrain-416_273e_coco_rgb_depth_attention_se_d.py',
                        help='Yolo V3 configuration.')
    parser.add_argument('--checkpoint',
                        type=str,
                        default = r'G:\mmdetection_miner_result\work_dir_rgb_depth_attention_se_d_simple/epoch_173.pth',
                        help='checkpoint.')
    ...
    parser.add_argument('--save-dir',
                        type=str,
                        default = r'G:\mmdetection_miner_result\work_dir_rgb_depth_attention_se_d_simple\val\drise',
                        help='save dir.')
