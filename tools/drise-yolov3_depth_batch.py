...
def main(args):
    ...
    rgb_path = r"G:\mmdetection_miner\data\ht_cumt_rgbd_drise\depth_val/"
...
def parse_args():
    ...
    parser.add_argument('--config',
                        type=str,
                        default = 'configs/yolo/yolov3_d53_mstrain-416_273e_coco_depth.py ',
                        help='Yolo V3 configuration.')
    parser.add_argument('--checkpoint',
                        type=str,
                        default = r'G:\mmdetection_miner_result\work_dirs_depth_simple/epoch_138.pth',
                        help='checkpoint.')
    ...
    parser.add_argument('--image-path',
                        ...
                        default =r"G:\mmdetection_miner\data\ht_cumt_rgbd\depth_val/RGBD_r_15_255.jpg",
                        help='image path.')
    ...
    parser.add_argument('--save-dir',
                        type=str,
                        default = r'G:\mmdetection_miner_result\work_dirs_depth_simple\val\drise',
                        help='save dir.')
