...
def parse_args():
    ...
    parser.add_argument('--config',
                        type=str,
                        default = 'configs/yolo/yolov3_d53_mstrain-416_273e_coco.py ',
                        help='Yolo V3 configuration.')
    parser.add_argument('--checkpoint',
                        type=str,
                        default = r'G:\mmdetection_miner_result\work_dirs_rgb_simple/epoch_178.pth',
                        help='checkpoint.')
    ...
    parser.add_argument('--image-path',
                        ...
                        default =r"G:\roadway_collect_dataset\recordData_process_annotation_sum_negative_new\JPEGImages_val/RGBD_r_15_255.jpg",
                        help='image path.')
    ...
    parser.add_argument('--save-dir',
                        type=str,
                        default = r'G:\mmdetection_miner_result\work_dirs_rgb_simple\val\drise',
                        help='save dir.')
