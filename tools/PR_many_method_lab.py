...
def plot_pr_curve(config_file, result_file, metric="bbox",format='r-',name='None'):
    ...
    # plot PR curve
    plt.plot(x, pr_array1,format, label=name)
...
if __name__ == "__main__":
    ...
    plot_pr_curve(config_file="configs/yolo/yolov3_d53_mstrain-416_273e_coco.py",
                  result_file=r"G:/mmdetection_miner_result/work_dirs_rgb_simple\val/yolov3 - 副本.pkl", metric="bbox",format='b-',name="YOLOv3")
    plot_pr_curve(config_file="configs/yolo/yolov3_d53_mstrain-416_273e_coco_depth.py",
                  result_file=r"G:/mmdetection_miner_result/work_dirs_depth_simple\val/yolov3 - 副本.pkl",
    ...
    plot_pr_curve(config_file="configs/yolo/yolov3_d53_mstrain-416_273e_coco_rgb_depth_attention_se_just_four.py",
                  result_file=r"G:/mmdetection_miner_result/work_dir_rgb_depth_attention_se_just_four_simple\val/yolov3 - 副本.pkl",
                  metric="bbox", format='r-', name="Ours")
    # plot_pr_curve(config_file=CONFIG_FILE, result_file=RESULT_FILE, metric="bbox")
    # plt.legend(handles=[l1,l2], labels=['YOLOv3', 'Ours'], loc='best')
    plt.legend(['YOLOv3-RGB','YOLOv3-Depth','Proposed method'], loc="best")
